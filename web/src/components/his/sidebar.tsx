...
const NAV: NavEntry[] = [
  ...
  { type: "item", href: "/reception", label: "Reception", icon: MonitorCheck, roles: ["ADMIN", "RECEPTIONIST"] },
  {
    ...
    children: [
      { type: "item", href: "/opd",                       label: "1. OPD Queue / Check-in", icon: MonitorCheck, roles: ["ADMIN", "NURSE", "RECEPTIONIST", "DOCTOR", "BILLING"] },
      { type: "item", href: "/opd/journey/vitals",        label: "2. Vitals & Triage",      icon: Activity,     roles: ["ADMIN", "NURSE", "RECEPTIONIST", "DOCTOR", "BILLING"] },
      { type: "item", href: "/opd/journey/consultation",  label: "3. Consultation",          icon: Stethoscope,  roles: ["ADMIN", "NURSE", "RECEPTIONIST", "DOCTOR", "BILLING"] },
      { type: "item", href: "/billing",                   label: "4. Billing",               icon: Receipt,      roles: ["ADMIN", "BILLING", "RECEPTIONIST"] },
    ],
  },
  { type: "item", href: "/patients",             label: "Patients",        icon: Users,       roles: ["ADMIN", "NURSE", "RECEPTIONIST", "DOCTOR", "BILLING"] },
  { type: "item", href: "/patients/new",         label: "Register Patient",icon: UserPlus,    roles: ["ADMIN", "NURSE", "RECEPTIONIST"] },
  { type: "item", href: "/appointments",         label: "Appointments",    icon: CalendarDays,roles: ["ADMIN", "NURSE", "RECEPTIONIST", "DOCTOR"] },
  { type: "item", href: "/appointments/new",     label: "Book Appointment",icon: CalendarDays,roles: ["ADMIN", "NURSE", "RECEPTIONIST", "DOCTOR"] },
